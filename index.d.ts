 ...
 * `{
   *   "product": {
    ...
    export interface NodeTypeResolver<TParent = any> {
      (parent: TParent, context: any, info: GraphQLResolveInfo): 'Article' | 'Metafield' | 'Blog' | 'Collection' | 'Product' | 'ProductOption' | 'ProductVariant' | 'Location' | 'MailingAddress' | 'Checkout' | 'AppliedGiftCard' | 'CheckoutLineItem' | 'Order' | 'Page' | 'ShopPolicy' | 'MediaImage' | 'Comment' | 'Cart' | 'CartLine' | 'Payment' | 'ExternalVideo' | 'Model3d' | 'Video';
    }
    export interface HasMetafieldsTypeResolver<TParent = any> {
      (parent: TParent, context: any, info: GraphQLResolveInfo): 'Article' | 'Blog' | 'Collection' | 'Product' | 'ProductVariant' | 'Customer' | 'Order' | 'Page' | 'Shop';
    }
    ...
    export interface MetafieldParentResourceTypeResolver<TParent = any> {
      (parent: TParent, context: any, info: GraphQLResolveInfo): 'Article' | 'Blog' | 'Collection' | 'Customer' | 'Order' | 'Page' | 'Product' | 'ProductVariant' | 'Shop';
    }
    ...
    export interface OnlineStorePublishableTypeResolver<TParent = any> {
      (parent: TParent, context: any, info: GraphQLResolveInfo): 'Article' | 'Blog' | 'Collection' | 'Product' | 'Page';
    }
    ...
    export interface MediaTypeResolver<TParent = any> {
      (parent: TParent, context: any, info: GraphQLResolveInfo): 'MediaImage' | 'ExternalVideo' | 'Model3d' | 'Video';
    }
    ...
    export interface SellingPlanPriceAdjustmentValueTypeResolver<TParent = any> {
      (parent: TParent, context: any, info: GraphQLResolveInfo): 'SellingPlanFixedAmountPriceAdjustment' | 'SellingPlanFixedPriceAdjustment' | 'SellingPlanPercentagePriceAdjustment';
    }
    ...
    export interface MetafieldReferenceTypeResolver<TParent = any> {
      (parent: TParent, context: any, info: GraphQLResolveInfo): 'MediaImage' | 'Page' | 'Product' | 'ProductVariant';
    }
    ...
    export interface CartDiscountAllocationTypeResolver<TParent = any> {
      (parent: TParent, context: any, info: GraphQLResolveInfo): 'CartAutomaticDiscountAllocation' | 'CartCodeDiscountAllocation';
    }
    ...
    export interface MerchandiseTypeResolver<TParent = any> {
      (parent: TParent, context: any, info: GraphQLResolveInfo): 'ProductVariant';
    }
    ...
    export interface DisplayableErrorTypeResolver<TParent = any> {
      (parent: TParent, context: any, info: GraphQLResolveInfo): 'CartUserError' | 'CheckoutUserError' | 'UserError' | 'CustomerUserError';
    }
